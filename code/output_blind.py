...
if __name__ == '__main__':
    ...
    args.exp_name = 'blinded_%s' % args.dataset
    print(args.exp_name)
    ...
    if args.dataset == 'CelebA':
        test_dataset = CelebaDataset(
                    ...
                    npz_dir=ROOT + ('/blinded_data/CelebA_crop128/cacheline/%s/' % mask),
        ...
        test_dataset = ChestDataset(
                    img_dir=args.data_path[args.dataset]['media'], 
                    npz_dir=ROOT + ('/blinded_data/ChestX-ray_jpg128/cacheline/%s/' % mask),
                    split=args.data_path[args.dataset]['split'][1],
                    trace_c=args.trace_c,
                    trace_w=args.trace_w,
                    image_size=args.image_size,
        ...
        test_dataset = SC09Dataset(
                    ...
                    npz_dir=ROOT + ('/blinded_data/SC09/cacheline/%s/' % mask),
                    split=args.data_path[args.dataset]['split'][1],
                    trace_c=args.trace_c,
                    trace_w=args.trace_w,
                    max_db=args.max_db,
        ...
        test_dataset = URMPDataset(
                    lms_dir=args.data_path[args.dataset]['media'],
                    npz_dir=ROOT + ('/blinded_data/Sub-URMP/cacheline/%s/' % mask),
                    split=args.data_path[args.dataset]['split'][1],
                    trace_c=args.trace_c,
                    trace_w=args.trace_w,
                    max_db=args.max_db,
        ...
        test_dataset = CaptionDataset(
                    ...
                    npz_dir=ROOT + ('/blinded_data/COCO_text/cacheline/%s/' % mask),
        ...
        test_dataset = DailyDialogDataset(
                    text_dir=args.data_path[args.dataset]['media'],
                    npz_dir=ROOT + ('/blinded_data/DailyDialog_text/cacheline/%s/' % mask),
                    dict_path=args.data_path[args.dataset]['vocab_path'],
                    split=args.data_path[args.dataset]['split'][1], 
                    side=args.side,
                    pad_length=args.pad_length,
